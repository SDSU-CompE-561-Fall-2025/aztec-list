...
<mark>Endpoint URL</mark>: `/api/v1/listings` <br>
HTTP Method : `GET` <br>
...
```
How this path works:
- The path `/api/v1/listings` identifies the listings collection.
- Filters are passed as query params (e.g., `/api/v1/listings?q=macbook&min_price=300`).
...
<mark>Endpoint URL</mark>: `/api/v1/listings/{listing_id}` <br>
HTTP METHOD: `GET` <br>
...
- Example request:
  `/api/v1/listings/4b8f1e9e-1a2b-4c33-8b7a-0ef5dfb12345`
...
```
How the path works
- The `/api/v1/listings` endpoint represents the collection of listings.
...
- `/api/v1/listings/{listing_id}` targets a specific listing by ID.
...
<mark>Endpoint URL</mark>: `/api/v1/users/{user_id}/listings`<br>
HTTP Method: `GET`<br>
...
How the path works:
- `/api/v1/users/{user_id}/listings` is a nested route, representing all listings owned by one user.
...
<mark>Endpoint URL</mark>: `/api/v1/auth/signup`<br>
HTTP Method: `POST`<br>
...
How the path works:
- `/api/v1/auth/signup` creates a new user resource in the authentication system.
...
- Once registered, users can authenticate using `/api/v1/auth/login`.

---

<mark>Endpoint URL</mark>: `/api/v1/auth/login`<br>
HTTP Method: `POST`<br>
...
How the path works:
- `/api/v1/auth/login` handles user authentication using credentials from the request body.
...
<mark>Endpoint URL</mark>: `/api/v1/users/{user_id}`<br>
HTTP Method: `GET`<br>
...
<mark>Endpoint URL</mark>: `/api/v1/users/profile` <br>
HTTP Method: `POST` <br>
...
<mark>Endpoint URL</mark>: `/api/v1/users/profile/picture` <br>
HTTP Method: `POST` <br>
...
<mark>Endpoint URL</mark>: `/api/v1/admin/actions` <br>
HTTP Method: `GET` <br>
...
<mark>Endpoint URL</mark>: `/api/v1/admin/actions/{action_id}` <br>
HTTP Method: `GET` <br>
...
<mark>Endpoint URL</mark>: `/api/v1/admin/users/{user_id}/strike` <br>
HTTP Method: `POST` <br>
...
<mark>Endpoint URL</mark>: `/api/v1/admin/users/{user_id}/ban` <br>
HTTP Method: `POST` <br>
...
<mark>Endpoint URL</mark>: `/api/v1/admin/listings/{listing_id}/remove` <br>
HTTP Method: `POST` <br>
